...
OUTPUT_FILES = {
    "gnss": "trajectory_01_gnss_old.png",
    "wheel": "trajectory_02_wheel_odometry_old.png",
    "vio": "trajectory_03_visual_odometry_old.png",
    "ekf_local": "trajectory_04_ekf_local_old.png",
    "ekf_global": "trajectory_05_ekf_global_old.png",
    "overlay": "trajectory_06_overlay_all_old.png",

    # GNSS基準範囲から大きく外れた軌跡も含めて確認するための
    # ズームアウト版重ね合わせ画像。
    "overlay_full": "trajectory_07_overlay_full_extent_old.png",
}
...
ANALYSIS_COMPLETE_FILENAME = "trajectory_analysis_complete_old.json"
...
def analysis_complete_marker_path(bag_dir: Path) -> Path:
    ...
    Returns:
        bagディレクトリ直下のtrajectory_analysis_complete_old.jsonのパス。
    """
...
def process_one_bag(
    ...
    bag_name = f"{bag_dir.name} [OLD yaw corrected]"
    ...
    marker_data = {
        "analysis": "trajectory_plots_old_bag_north_zero_ccw_to_enu",
