...
def generate_launch_description():
    ...
    # ファイルパス
    desc_share = get_package_share_directory("pm_description")
    vi_share = get_package_share_directory("pm_vehicle_interface")

    # URDFファイル
    default_urdf = os.path.join(desc_share, "urdf", "pm.urdf")
